...
/**
 * Created by youssef on 31-Aug-15.
 */
public class GenericRequest<T extends BaseResponse> extends JsonRequest<T> {
     ...
     */
    public GenericRequest(int method, Class<T> classtype, String url, String requestBody,
    ...
    protected Response<T> parseNetworkResponse(NetworkResponse response) {
        ...
        if (muteRequest) {
            ...
            try {
                ...
                parsedObject.fullResponse = json;
